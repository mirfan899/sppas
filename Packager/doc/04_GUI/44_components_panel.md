...
tiers. It will allow soon to estimate a user agreement rate (Kappa as a
first stage) and will includes TGA (Time Group Analyzer), available at 
<http://wwwhomes.uni-bielefeld.de/gibbon/TGA/>, a tool developped
by D. Gibbon, emeritus professor of English and General Linguistics at
