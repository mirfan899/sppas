...
class TestExport(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self._sample_1 = audiodata.io.open(TestExport._sample_path_1)
        self._sample_2 = audiodata.io.open(TestExport._sample_path_2)
    ...
    def test_Export_Change_Framerate(self):
        ...
        newaudio = audiodata.io.open(self._sample_path_new)
