...
parser = ArgumentParser(usage="{:s} -w file [options]"
                        ...
                        description="IPUs detection command line interface.")
...
w.print_message('Parameters of the IPUs search:')
w.print_message('\t- shift start: {:f}'.format(w.get_shift_start()))
w.print_message('\t- shift end: {:f}'.format(w.get_shift_end()))
w.print_message('\t- win len: {:f}'.format(w.get_win_length()))
w.print_message('\t- min ipu duration: {:f}'.format(w.get_min_ipu()))
w.print_message('\t- min sil duration: {:f}'.format(w.get_min_sil()))
w.print_message('\t- vol. threshold: {:f}'.format(w.get_threshold()))
