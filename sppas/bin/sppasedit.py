...
if sys.version_info < (2, 7):
    tkMessageBox.showwarning(
        "Python Error...",
        "Your python version is too old. SppasEdit requires 2.7\n. Verify your python installation and try again."
        )
    sys.exit(1)
...
if sys.version_info >= (3, 0):
    tkMessageBox.showwarning(
        "Python Error...",
        "Your python version is not appropriate. SppasEdit requires 2.7\n. Verify your python installation and try again."
        )
    sys.exit(1)
...
parser = ArgumentParser(usage="%s files" % os.path.basename(PROGRAM), description="SppasEdit graphical user interface.")
...
arguments = {}
arguments['files'] = []
arguments['title'] = "SppasEdit"
arguments['type']  = "ANYFILES"
arguments['icon']  = SPPASEDIT_APP_ICON

app = wx.App()
frame = SppasEditFrame(None, -1, arguments)
