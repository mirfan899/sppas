...
from sppas.src.ui.wxgui.sp_images import WIZARD_WELCOME_TRS_BMP
from sppas.src.ui.wxgui.cutils.imageutils import ScaleImage

# ----------------------------------------------------------------------------


class WizardTrsDemo( wx.wizard.Wizard ):

    def __init__(self, parent):
        wx.wizard.Wizard.__init__(self, parent, -1, "SppasEdit. Ann. Files Demo")
        self.parent = parent
...
class WelcomePage(wx.wizard.WizardPageSimple):
    ...
    def __init__(self, parent, title):
        ...
        img = ScaleImage( wx.Image(WIZARD_WELCOME_TRS_BMP, wx.BITMAP_TYPE_ANY), 460, 280)
