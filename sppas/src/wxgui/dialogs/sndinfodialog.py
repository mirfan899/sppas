...
class SndInfoDialog( wx.Dialog ):
    ...
    def __init__(self, parent, prefsIO, sndname):
    ...
    def _create_title_label(self):
        ...
        self.title_label = wx.StaticText(self, label="Speech sound properties", style=wx.ALIGN_CENTER)
