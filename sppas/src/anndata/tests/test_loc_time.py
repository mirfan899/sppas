...
class TestTimeDisjoint(unittest.TestCase):
    ...
    def test__eq__(self):
        intervals1 = sppasTimeDisjoint([sppasTimeInterval(sppasTimePoint(i), sppasTimePoint(i+1)) for i in range(10)])
        intervals2 = sppasTimeDisjoint([sppasTimeInterval(sppasTimePoint(i), sppasTimePoint(i+1)) for i in range(10)])
    ...
    def test_Is(self):
        ...
        self.assertTrue(t_disjoint.is_time_disjoint())
    ...
    def test_Set(self):
        ...
        self.assertEqual(t_disjoint.End, sppasTimePoint(11))
        with self.assertRaises(ValueError):
