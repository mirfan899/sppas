...
class PluginConfigFileError(IOError):
    ...
    def __init__(self):
        self.parameter = CFG_FILE_ERROR + (t.gettext(CFG_FILE_ERROR))
...
class PluginArchiveFileError(Exception):
    ...
    def __init__(self):
        self.parameter = ARCHIVE_FILE_ERROR + (t.gettext(ARCHIVE_FILE_ERROR))
...
class PluginArchiveIOError(IOError):
    ...
    def __init__(self):
        self.parameter = ARCHIVE_IO_ERROR + (t.gettext(ARCHIVE_IO_ERROR))
...
class PluginDuplicateError(IOError):
    ...
    def __init__(self):
        self.parameter = DUPLICATE_ERROR + (t.gettext(DUPLICATE_ERROR))
...
class PluginKeyError(KeyError):
    ...
    def __init__(self):
        self.parameter = PLUGIN_KEY_ERROR + (t.gettext(PLUGIN_KEY_ERROR))
